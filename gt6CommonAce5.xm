...
<manifest>
  ...
  <remote fetch="https://github.com/realme-kernel-opensource" name="realme"/>
  <remote fetch="https://github.com/Carl1984" name="Carl1984"/>
  <project remote="origin" name="android_kernel_common_oneplus_sm8650" path="kernel_platform/common" revision="oneplus/sm8650_v_15.0.0_oneplus_ace5" clone-depth="1">
    <linkfile dest="kernel_platform/.source_date_epoch_dir" src="."/>
  </project>
  <project remote="realme" name="realme_GT6-AndroidV-kernel-source-" path="kernel_platform/msm-kernel" revision="master" clone-depth="1">
  ...
  <project remote="Carl1984" name="realme_GT6-AndroidV-vendor-source" path="./" revision="master"  clone-depth="1"/>
